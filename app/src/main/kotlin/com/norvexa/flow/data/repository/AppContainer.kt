...
class AppContainer(context: Context) {
    val database: NorvexaDatabase = Room.databaseBuilder(context.applicationContext, NorvexaDatabase::class.java, "norvexa-flow.db").fallbackToDestructiveMigration().build()
